        ...
        openDetail(subFactor) {
            ...
            this.ui.panelContent.innerHTML = `
                ...
                <div class="action-container" style="margin-top: 32px; padding-top: 24px; border-top: 1px solid var(--color-border); flex-wrap: wrap;">
                    ...
                    ${subFactor.knowledgeLink ? `
                        <a href="${subFactor.knowledgeLink}" class="action-btn knowledge-link-btn">
                            ...
                            📙 深度學習：${(subFactor.title || '').includes('. ') ? subFactor.title.split('. ')[1] : subFactor.title} 完整百科
                        </a>
                    ` : ''}
                </div>
            `;
