...
(function () {
    ...
    function getInitialTheme() {
        ...
        // 2. Default (Always Dark unless user overrides)
    ...
    if ('serviceWorker' in navigator) {
        window.addEventListener('load', function() {
            // Check if we are at root or deep path to register relative to root
            const swPath = window.location.pathname.includes('/post/') || window.location.pathname.includes('/knowledge/') ? '../sw.js' : './sw.js';
