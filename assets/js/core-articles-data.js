 ...
 * 
 * 1. 職責：全站文章目錄與 SEO 資訊中心。
 * 2. 欄位規範：
 *    - id: 必須唯一且符合 kebab-case。
 *    - title: 統一使用此屬性。
 *    - link: 文章相對路徑。
 * 3. 維護規則：新增文章後需同步更新 sitemap.xml。
 */
(function (global) {
    // Private Data Source
    const _articles = [
        {
            id: 'card-btc-valuation-models',
            category: 'core',
            ...
            desc: '深入探討比特幣的五大估值維度，包括資產對標法、網路效應、供給側模型與鏈上數據分析。建立科學的加密貨幣估值框架。',
            link: 'post/btcoin-valuation-models.html',
            keywords: '比特幣, 估值模型, 數位黃金, 梅特卡夫定律, S2F 模型, 冪律模型, 宏觀分析, 加密貨幣'
        },
        {
        ...
        {
            id: 'topic-btc-sovereign-liquidity',
            category: 'analysis',
            ...
            desc: '從 MVRV Z-Score、2年均線乘數、Power Law、RSI 到彩虹圖，深度解析為何當前市場處於絕佳的低估買入區間。',
            link: 'post/topic-btc-sovereign-liquidity.html',
            keywords: '市場分析, 比特幣週期, 鏈上數據, MVRV Z-Score, 2-Year MA Multiplier, Power Law Corridor, Monthly RSI, Rainbow Chart, 加密貨幣, 投資策略'
        },
        {
            id: 'topic-btc-macro-analysis',
            category: 'analysis',
            published: '2026-03-09',
            modified: '2026-03-09',
            tag: '市場分析',
            tagColor: 'text-blue-500',
            title: '比特幣 × 宏觀 7 大指標全景解析：CPI、M2、美債、聯準會如何共振驅動 BTC 週期？',
            desc: '深度解析 7 大宏觀數據（CPI、M1、M2、美元貶值、10yr 美債、30yr 房貸利率、聯準會資產負債表）如何共同驅動比特幣長線週期，附 2026 年現況判定與未來推論。',
            link: 'post/topic-btc-macro-analysis.html',
            keywords: 'BTC, CPI, M1, M2, 宏觀經濟, 美債收益率, 聯準會, 量化寬鬆, QE, QT, 聯準會資產負債表, WALCL, 房貸利率, 美元貶值, 通膨, 流動性, 比特幣週期'
        },
    ];
