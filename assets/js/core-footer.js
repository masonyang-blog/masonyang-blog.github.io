    ...
    class FooterComponent {
        constructor(hostElement) {
            ...
            this._config = {
                ...
                disclaimer: "這裡是我的個人寫作空間，客觀記錄關於區塊鏈技術、總體經濟數據與加密貨幣市場的思考過程。<br>免責聲明：本站內容僅供資訊參考，不構成任何投資建議。"
            };
        }
        ...
        createStyles() {
            ...
            style.textContent = `
                ...
                :host-context(html.dark) .footer-link {
                    color: #787B86;
                }

                :host-context(html.dark) .footer-link:hover {
                    color: #D1D4DC;
                    text-decoration: underline;
                }
            `;
