 ...
 * 解耦架構：資料正規化、多維度過濾、排序與 URL 狀態委託給 ArticlesFilterEngine 處理。
 */
(function (global) {
    "use strict";
    ...
    class ArticlesSpreadsheetComponent {
        ...
        loadData() {
            ...
            if (EngineClass) {
                ...
                console.warn("ArticlesSpreadsheetComponent: ArticlesFilterEngine not found, fallback enabled.");
            }
            ...
            repoPromise.then(repo => {
                ...
                if (this._config.debug) {
                    console.log(`ArticlesSpreadsheetComponent: Loaded ${this._state.articles.length} articles.`);
                }
