        ...
        updateUI() {
            ...
            if (diffEl && badgeEl) {
                ...
                if (diffPct > 30) {
                    ...
                    badgeHtml = `<span class="px-2.5 py-1 text-xs font-bold rounded bg-red-100 text-red-800 dark:bg-red-950 dark:text-red-300 border border-red-300 dark:border-red-800">泡沫高估預警</span>`;
                } else if (diffPct < -20) {
                    ...
                    badgeHtml = `<span class="px-2.5 py-1 text-xs font-bold rounded bg-blue-100 text-blue-800 dark:bg-blue-950 dark:text-blue-300 border border-blue-300 dark:border-blue-800">估值處於合理區間</span>`;
                }
