            ...
            this._config = {
                ...
                navLinks: [
                    ...
                    { text: "深度專題", href: `${prefix}index.html#series-themes` },
                    {
                        ...
                        isDropdown: true,
                        children: [
                            { text: "個股與企業研究", href: `${prefix}post/archive.html?filter=equity-research` },
                            { text: "宏觀戰略與地緣政治", href: `${prefix}post/archive.html?filter=macro-geopolitics` },
                            { text: "數位資產與 Web3", href: `${prefix}post/archive.html?filter=crypto-web3` },
                            { text: "傳統金融與市場", href: `${prefix}post/archive.html?filter=traditional-markets` },
                            { text: "科技趨勢與 AI", href: `${prefix}post/archive.html?filter=tech-ai` },
                            { text: "投研方法與工具", href: `${prefix}post/archive.html?filter=research-tools` }
                        ]
                    },
